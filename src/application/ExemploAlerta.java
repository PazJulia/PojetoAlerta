	...
	public void init() throws Exception {
		...
		button01.setOnAction(new EventHandler <ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				alert.setContentText("Você clicou no evento01");
				alert.show();
			}
		});
		...
		button02.setOnAction(new EventHandler <ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				alert.setContentText("Você clicou no evento02");
				alert.show();
			}
		});
		...
		button03.setOnAction(new EventHandler <ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				alert.setHeaderText("Essa operação é um pouco crítica");
				alert.setContentText("Você deseja realmente excluir?");
		...
		button04.setOnAction(new EventHandler <ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				alert.setContentText("Você clicou no botão 4 .. mais info");
		...
		button06.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				dialog.setHeaderText("Cabeçalho");
